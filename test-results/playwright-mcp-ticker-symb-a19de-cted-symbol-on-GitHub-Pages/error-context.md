...
- Name: playwright-mcp\ticker-symbol-filter-github.spec.ts >> ticker updates for selected symbol on GitHub Pages
- Location: playwright-mcp\ticker-symbol-filter-github.spec.ts:3:5
