# APM v1  —  15m indicator improvement sweep
#
# PROBLEM WITH v1.2 ON 15m
...
# ── Base filters (v1.2 entry conditions, ADX threshold swept separately) ──────
...
# ── PHASE 1: Direction isolation at v1.2 params ───────────────────────────────
print("=== PHASE 1: Direction isolation (v1.2 params TP=3.5 SL=2.0) ===")
adx_25 = df["ADX"] > 25
...
# Save CSV
out_csv = f"apm_v1_trades_{TICKER.replace('-','').lower()}_{INTERVAL}.csv"
...
ax1.set_title(
    f"APM v1.3 Shorts-Only  |  {TICKER} {INTERVAL}  |  "
...
out_png = f"apm_v1_equity_{TICKER.replace('-','').lower()}_{INTERVAL}.png"
