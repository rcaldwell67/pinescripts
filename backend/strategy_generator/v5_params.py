...
DEFAULT_V5_PARAMS: dict[str, Any] = {
    "signal": {
        "ema_fast": 21,
        "ema_mid": 50,
        "ema_slow": 200,
...
def _default_config_path() -> Path:
    return Path(__file__).resolve().parent / "configs" / "v5_runtime.json"
...
def get_v5_params(
    ...
    merged = _deep_merge(DEFAULT_V5_PARAMS, loaded)
