...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run v1 backtests and print a strategy-guideline matrix by symbol/class.")
    parser.add_argument("--version", default="v1", help="Strategy version (default: v1)")
    parser.add_argument("--profile", help="Optional v1 runtime profile, e.g. eth_focus")
    parser.add_argument(
        "--asset-class",
