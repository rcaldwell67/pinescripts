...
DEFAULT_V3_PARAMS: dict[str, Any] = {
    "signal": {
        "ema_fast": 21,
        "ema_mid": 50,
        "ema_slow": 200,
...
def _default_config_path() -> Path:
    return Path(__file__).resolve().parent / "configs" / "v3_runtime.json"
...
def get_v3_params(
    ...
    merged = _deep_merge(DEFAULT_V3_PARAMS, loaded)
