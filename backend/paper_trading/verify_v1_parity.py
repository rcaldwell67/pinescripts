"""
Validate v1 trade-level parity between backtest and paper modes in tradingcopilot.db.
...
Usage:
    ...
    python backend/paper_trading/verify_v1_parity.py --version v1 --max-row-diffs 20
"""
